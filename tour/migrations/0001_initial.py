    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('NA', 'National Newspaper'), ('IN', 'International Newspaper'), ('RN', 'Regional Newspaper'), ('JM', 'Journal/Magazine'), ('OT', 'Others')], default='NA', max_length=4)),
                ('n_type', models.CharField(choices=[('FR', 'Free Newspaper'), ('PD', 'Paid Newspaper'), ('OT', 'Others')], default='FR', max_length=4)),
                ...
                ('website', models.CharField(blank=True, max_length=200, null=True)),
                ('added_date', models.DateTimeField(blank=True, null=True, verbose_name='date published')),
                ('operator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tour.operator')),
            ],
        ),
        migrations.CreateModel(
            name='Choice',
